...
Ce guide est pour les PME déployeuses — celles qui utilisent des outils IA tiers dans leurs processus — avec un plan d'action en 5 étapes testé sur un cas réel.
...
## Cas concret : mise en conformité complète en 3 semaines — coût réel 0 €

Ce cas est celui d'une PME e-commerce de 45 salariés que nous avons accompagnée sur la conformité AI Act au premier trimestre 2026.
