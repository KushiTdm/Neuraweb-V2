      ...
      <main id="main-content" className="min-h-screen bg-white dark:bg-[#050510] pt-24">
        ...
        <section className="py-16 px-4">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <LocalizedLink href="/contact" className="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold text-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300">
              {t('equipe.cta.button')}
