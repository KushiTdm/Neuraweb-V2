    ...
    <section className="bg-gradient-to-br from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 overflow-hidden relative min-h-screen sm:min-h-0 py-12 sm:py-16 md:py-20">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col justify-center">
        ...
        <div className="relative">
          {/* Guillemet décoratif */}
          <div className="absolute -top-4 -left-2 sm:-top-6 sm:-left-4 z-10" aria-hidden="true">
          ...
          >
            ...
            {/* Étoiles */}
            <div className="flex items-center gap-1 mb-4 sm:mb-6" role="img" aria-label={`${testimonial.rating} étoiles sur 5`}>
              ...
              {/*
                FIX contraste "5.0" :
                text-amber-500 sur bg-amber-50 → ratio ~2.5:1 (insuffisant)
                dark: text-amber-500 sur dark:bg-amber-900/20 → ratio ~2.8:1 (insuffisant)
                
                Solution : text-amber-700 sur bg-amber-100 → ratio ~5.2:1 ✓
                dark: text-amber-300 sur dark:bg-amber-900/40 → ratio ~5.0:1 ✓
              */}
              <span className="ml-2 text-xs font-semibold text-amber-700 bg-amber-100 dark:bg-amber-900/40 dark:text-amber-300 px-2 py-0.5 rounded-full">
                {testimonial.rating}.0
              </span>
            </div>

            {/* Texte */}
            <blockquote className="text-base sm:text-lg md:text-xl text-gray-700 dark:text-gray-100 leading-relaxed mb-6 sm:mb-8 italic">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              <div className="flex items-center gap-4">
                <div className="relative flex-shrink-0">
                  ...
                  {/* Badge vérifié */}
                  <div
                    className="absolute -bottom-1 -right-1 w-5 h-5 bg-gradient-to-br from-blue-500 to-purple-600 rounded-full flex items-center justify-center border-2 border-white dark:border-gray-800"
                    aria-hidden="true"
                  >
              ...
              {/*
                FIX contraste compteur "02 / 06" :
                text-gray-300 (light) → ratio ~1.8:1 sur fond blanc → insuffisant
                dark:text-gray-600 → ratio ~3.0:1 sur dark bg → insuffisant
                
                Solution : text-gray-500 dark:text-gray-400 → ratios ~4.5:1 ✓
                
                Note : le compteur est purement décoratif/redondant (info aussi
                donnée par le compteur de navigation en-dessous), mais on le corrige
                quand même pour passer l'audit.
              */}
              <div
                className="sm:ml-auto text-center sm:text-right text-xs font-mono text-gray-500 dark:text-gray-400 select-none"
                aria-hidden="true"
              >
        ...
        <div className="flex items-center justify-center gap-8 mt-8 sm:mt-10">
          ...
          >
            <ChevronLeft className="w-6 h-6 sm:w-7 sm:h-7 text-white group-hover:-translate-x-0.5 transition-transform" aria-hidden="true" />
          </button>
          ...
          >
            <ChevronRight className="w-6 h-6 sm:w-7 sm:h-7 text-white group-hover:translate-x-0.5 transition-transform" aria-hidden="true" />
          </button>
        </div>
      </div>
    </section>
