  ...
  return (
    ...
    >
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-[52%_48%] gap-14 xl:gap-20 items-center">
          ...
          >
            <div className="relative rounded-3xl overflow-hidden shadow-xl" style={{ height: '520px' }}>
              <Image
