...
const SEO_CONTEXTS_BY_LANG: Record<Language, Record<PageType, PageSEOConfig>> = {
  fr: {
    ...
    portfolio: {
      title: 'Portfolio NeuraWeb — Sites Web, Apps & Solutions IA',
      description: 'Découvrez les réalisations de NeuraWeb : sites Next.js, applications mobiles iOS/Android et solutions IA. Plus de 16 projets livrés, clients 5 étoiles.',
      keywords: ['portfolio', 'réalisations', 'projets web', 'cas client'],
    },
    blog: {
      title: 'Blog NeuraWeb — Actualités Web, IA & Automatisation',
      description: "Articles et guides sur le développement web Next.js, l'intégration IA et l'automatisation n8n. Tendances tech pour startups et PME françaises.",
      keywords: ['blog', 'articles', 'conseils web', 'tutoriels'],
    },
    custom: {
      title: 'NeuraWeb — Agence Web Sur Mesure, IA & Automatisation',
  ...
  en: {
    ...
    portfolio: {
      title: 'Portfolio NeuraWeb — Web, Mobile Apps & AI Projects',
      description: "Explore NeuraWeb's portfolio: Next.js websites, iOS/Android mobile apps and AI solutions. Over 16 projects delivered and rated 5 stars by our clients.",
      keywords: ['portfolio', 'work', 'web projects', 'case studies'],
    },
    blog: {
      title: 'Blog NeuraWeb — Web, AI & Automation News and Tips',
      description: 'Articles and guides on Next.js development, AI integration and n8n automation. Stay informed about the latest tech trends to grow your business.',
      keywords: ['blog', 'articles', 'web tips', 'tutorials'],
    },
    custom: {
      title: 'NeuraWeb — Custom Web, AI & Automation Agency, France',
  ...
  es: {
    ...
    contact: {
      ...
      description: 'Contacta con NeuraWeb para hablar de tu proyecto web, app móvil o integración IA. Respuesta garantizada en 24h y presupuesto gratuito sin compromiso.',
      keywords: ['contacto', 'presupuesto gratis', 'proyecto web'],
    },
    portfolio: {
      title: 'Portafolio NeuraWeb — Webs, Apps Móviles & Soluciones IA',
      description: 'Descubre el portafolio de NeuraWeb: webs Next.js, apps móviles iOS/Android y soluciones IA. Más de 16 proyectos entregados y valorados con 5 estrellas.',
      keywords: ['portafolio', 'proyectos', 'proyectos web', 'casos de clientes'],
    },
    blog: {
      title: 'Blog NeuraWeb — Noticias y Consejos sobre Web e IA',
      description: 'Artículos y guías sobre desarrollo web Next.js, integración IA y automatización n8n. Aprende las últimas tendencias tech para escalar tu negocio digital.',
